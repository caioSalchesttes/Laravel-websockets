                                ...
                                <div class="py-md-5 py-4">
                                    ...
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control @error('username') is-invalid @enderror" id="username" placeholder="Digite o nome de usuário" required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="mb-4">
                                            <p class="mb-0">Ao se registrar, você concorda com o <a href="#" class="text-primary">Termos de uso</a></p>
                                        </div>
                                    ...
                                    <div class="mt-5 text-center text-muted">
                                        <p>Já tem uma conta ?<a href="{{route('login')}}"
